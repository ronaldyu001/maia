...
from backend.tools.memory.storage import load_json, save_json
...
def load_conversation( session_id: str ) -> list[dict]:
    ...
    try:
        ...
        SHORT_TERM = Path( f"backend/memory/raw/short_term/conversations" ) / f"{session_id}.json"
        LONG_TERM = Path( f"backend/memory/raw/long_term/conversations" ) / f"{session_id}.json"
